...
export const coreMessage =
  "Tested with sensitive skin. Built for the routine you keep up with.";
...
export const regions = [
  {
    ...
    home: {
      ...
      title: "Skincare your skin can live with.",
      description:
        "Lightweight daily formulas for sensitive skin. We make three things, and we make them to support your skin barrier over years, not weeks.",
      cta: "Shop skincare",
      heroImage: {
        url: "/images/hero.png",
      ...
      benefits: [
        {
          ...
          description: "We hydrate first so the skin barrier holds up to the rest of your day."
        },
        {
          title: "Daily, not heroic",
          description: "Light enough that you reach for it every morning, not just on a good week."
        },
        {
          title: "Three formulas, on purpose",
          description: "We narrowed the line so each product earns its spot in your routine."
        }
      ],
      review:
        "The routine feels simple and consistent. My skin feels hydrated without heaviness.",
      resultTitle: "Calmer skin you keep showing up for.",
      resultDescription:
        "Use it daily and the difference compounds. Most people see calmer, more even skin by week four.",
      resultImages: {
        before: {
    ...
    footerText:
      "Sensitive-skin skincare for the routine you keep up with for years."
  },
  {
    code: "me",
    label: "Middle East",
    ...
    home: {
      ...
      title: "Skincare your skin can live with.",
      description:
        "Lightweight formulas built for the heat. Gentle on sensitive skin, light enough to wear from morning errand into a long evening.",
      ...
      benefits: [
        {
          title: "Barrier hydration",
          description: "We hydrate first so your skin holds up to AC, sun, and the move between them."
        },
        {
          title: "Daily, not heroic",
          description: "Light enough that you reach for it every morning, even on the hottest days."
        },
        {
          title: "Three formulas, on purpose",
          description: "We narrowed the line so each product earns its spot in your routine."
    ...
    footerText:
      "Sensitive-skin skincare for warm climates. Made for the routine you keep up with."
  }
];
