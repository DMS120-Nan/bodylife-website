...
export const regions = [
  {
    ...
    home: {
      ...
      description:
        "Lightweight daily formulas — comfortable enough for sensitive skin, designed to support a healthy skin barrier over time.",
      cta: "Shop skincare",
      heroImage: {
        url: "/images/hero.png",
      ...
      resultTitle: "Skin you actually feel comfortable in.",
      resultDescription:
        "Consistent, gentle care helps your skin feel calmer and more comfortable — week after week.",
      resultImages: {
        before: {
    ...
    footerText:
      "Made for sensitive skin. Built for the long routine you actually keep up with."
  },
  {
    code: "me",
    label: "Middle East",
    ...
    home: {
      ...
      title: "Gentle skincare, guided by skin science.",
      description:
        "Lightweight formulas built for warm climates — gentle on sensitive skin, designed to keep your skin comfortable from morning into evening.",
    ...
    footerText:
      "Built for warm climates. Gentle enough for the routine you actually keep up with."
  }
];
