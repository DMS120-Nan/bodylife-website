    ...
    <StoreLayout region={region}>
      <div className="shipping-page">
        <div className="shipping-content">
          ...
          <section className="shipping-section">
            <h2>Questions?</h2>
            <p>Contact our team at <a href="mailto:support@bodylifeofficial.com">support@bodylifeofficial.com</a> or visit our <a href={`/${region.code}/contact`}>contact page</a>.</p>
          </section>
        </div>
      </div>
    </StoreLayout>
